...
**********************`
  ...
  describe('parseReceiptItems', () => {
    ...
    it('should initial the quantity by given barcode with dash "-" then given same barcode' , () => {
      // given
      const barcodes = [
        'ITEM000003-2.5',
        'ITEM000003'
    ...
    it('should initial the quantity by given barcode first and then with dash "-" with same barcode', () => {
      // given
      const barcodes = [
        'ITEM000003',
        'ITEM000003-2.5'
